--[[
    GER Script for YBA v1.3
    FIXED: Proper silent aim for GER
]]
...
-- GER Silent Aim - ПРАВИЛЬНЫЙ МЕТОД
local xPressed = false
local aimTarget = nil

local oldIndex
oldIndex = hookmetamethod(game, "__index", newcclosure(function(self, key)
    if not checkcaller() and self:IsA("Humanoid") and key == "MoveDirection" and xPressed and Settings.GERAim and aimTarget then
        local myHRP = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
